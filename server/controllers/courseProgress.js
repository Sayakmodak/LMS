...
export const markAsCompleted = async (req, res) => {
    try {
        ...
        // if all the lecture are viewed then the course progress will be completed
...
export const markAsIncompleted = async (req, res) => {
    try {
        ...
        // if all the lecture are not viewed(false) then the course progress will be completed
        courseProgress.lectureProgress.map((lecture) => (
