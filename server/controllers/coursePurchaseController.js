...
export const createCheckoutSession = async (req, res) => {
    ...
    try {
        ...
        const newCoursePurchaseSchema = new CoursePurchase({
            courseId,
            userId,
        ...
        newCoursePurchaseSchema.paymentId = session.id;
        await newCoursePurchaseSchema.save();
    ...
    if (event.type === "checkout.session.completed") {
        ...
        try {
            ...
            const purchase = await CoursePurchase.findOne({
                paymentId: session.id, // finding the purchased course using payment Id
...
export const courseDetailsWithPurchasedStatus = async (req, res) => {
    try {
        ...
        return res.status(200).json({
            success: true,
            course,
            purchase: !!purchase    // true or false 
        })
    } catch (error) {
        console.log(error);
    }
